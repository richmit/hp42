...
@@@@ FLG: 81  Set: We are on DM42, Clear: We are not on DM42
@@@@ UPD: 2021-03-20
LBL "BVIEW"
...
R↓
R↓
@@@@ Bit beyond WSIZE.  Print something
0
LSTO "CB"
GTO 14              @@@@ Remove this line if you want to pad numbers
LBL 12               @@@@ IF-END
R↓
@@@@ Figure out grouping
...
The skelliton was generated by the following code.  That skelliton has been fleshed out with some custom code.
...
XEQ "BVIEW"
RTN
LBL 60               @@@@ Action for menu key WSIZE
WSIZE
RTN
LBL 61               @@@@ Action for menu key WSIZE?
WSIZE?
RTN
LBL 62               @@@@ Action for menu key BSIGNED
BSIGNED
RTN
LBL 63               @@@@ Action for menu key BWRAP
BWRAP
RTN
END
