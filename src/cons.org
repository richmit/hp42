...
#+BEGIN_SRC elisp :var tbl=constants :colnames y :results output verbatum :wrap "src hp42s :tangle ../src_42s/cons/cons.hp42s"
(MJR-generate-42-menu-code "CONS"
                           tbl
                           "exit"
                           "up"
                           't
                           (lambda (row) (cl-destructuring-bind (sym desc desc-long val uncertainty units cat) row
...
#+RESULTS:
#+begin_src hp42s :tangle ../src_42s/cons/cons.hp42s
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ (ref:CONS)
