  ...
  (MJR-generate-42-menu-code "CONS" tbl "exit" "up" (lambda (row) (cl-destructuring-bind (sym desc desc-long val uncertainty units cat) row
                                                                    (let ((print-desc 't)    ;; Set to NIL to not print description
                                                                      ...
                                                                      (let* ((dlen (length desc))
                                                                             (dsc1 (cond ((< dlen 15) (concat desc (if print-unit "[LF]")))
                                                                                         ((>=  dlen 15) (substring desc 0 15))))
                                                                             (dsc2 (if (> dlen 14)
                                                                                       (if (< dlen 22)
                                                                                           (concat (substring desc 15) (if print-unit "[LF]"))
                                                                                           (substring desc 15 22)))))
                                                                        (mapconcat #'identity
                                                                                   (cl-remove nil (list (message "%s" val)
                                                                                                        (and print-desc      (message "\"%s\"" dsc1))
                                                                                                        (and print-desc dsc2 (message "├\"%s\"" dsc2))
                                                                                                        (and print-unit      (message "%s\"%s\"" (if print-desc "├" "") units))
                                                                                                        "AVIEW"))
                                                                                   "\n")))))))
#+END_SRC
...
AVIEW
RTN
LBL 09               @@@@ Action for menu key hbar
1.054571817e-34
"Dirac Constant[LF]"
├"J*s"
AVIEW
RTN
LBL 10               @@@@ Action for menu key c
299792458
"Speed of Light[LF]"
├"m/s"
AVIEW
RTN
LBL 11               @@@@ Action for menu key E0
8.8541878128e-12
"Vac Ele Permitt"
├"ivity[LF]"
├"F/m"
...
AVIEW
RTN
LBL 14               @@@@ Action for menu key tp
5.391247e-44
"Planck Time[LF]"
├"s"
AVIEW
RTN
LBL 15               @@@@ Action for menu key gacc
9.80665
"Earth Std Grav "
├"Accel[LF]"
├"m/s"
AVIEW
RTN
LBL 16               @@@@ Action for menu key atm
101325
"Standard Atmosp"
├"here[LF]"
├"Pa"
...
AVIEW
RTN
LBL 18               @@@@ Action for menu key μB
9.2740100783e-24
"Bohr Magneton[LF]"
├"J/T"
AVIEW
RTN
LBL 19               @@@@ Action for menu key e
1.602176634e-19
"Elementary Char"
├"ge[LF]"
├"C"
...
AVIEW
RTN
LBL 24               @@@@ Action for menu key F
96485.33212
"Faraday[LF]"
├"C/mol"
AVIEW
RTN
LBL 25               @@@@ Action for menu key Na
6.02214076e23
"Avogadro's Numb"
├"er[LF]"
├"1/mol"
...
AVIEW
RTN
LBL 29               @@@@ Action for menu key rc1
3.741771852e-16
"First Radiation"
├" Cnst[LF]"
├"W*m^2"
AVIEW
RTN
LBL 30               @@@@ Action for menu key rc2
1.438776877e-2
"Second Radiatio"
├"n Cnst[LF]"
├"m*K"
AVIEW
RTN
LBL 36               @@@@ Action for menu key a
7.2973525693e-3
"Fine Structure[LF]"
├""
AVIEW
RTN
LBL 37               @@@@ Action for menu key Eh
4.3597447222071e-18
"Hartree Energy[LF]"
├"J"
AVIEW
RTN
LBL 38               @@@@ Action for menu key Ry
10973731.56816
"Rydberg Constan"
├"t[LF]"
├"1/m"
AVIEW
RTN
LBL 39               @@@@ Action for menu key pro
1.67262192369e-27
"Proton Mass[LF]"
├"kg"
AVIEW
RTN
LBL 40               @@@@ Action for menu key ele
9.1093837015e-31
"Electron Mass[LF]"
├"kg"
AVIEW
RTN
LBL 41               @@@@ Action for menu key neut
1.67492749804e-27
"Neutron Mass[LF]"
├"kg"
AVIEW
RTN
LBL 42               @@@@ Action for menu key muon
1.883531627e-28
"Muon Mass[LF]"
├"kg"
AVIEW
RTN
LBL 43               @@@@ Action for menu key pro
1.41060679736e-26
"Proton Mag Mom[LF]"
├"J/T"
AVIEW
RTN
LBL 44               @@@@ Action for menu key ele
-9.2847647043e-24
"Electron Mag Mo"
├"m[LF]"
├"J/T"
AVIEW
RTN
LBL 45               @@@@ Action for menu key neut
-9.6623651e-27
"Neutron Mag Mom"
├"[LF]"
├"J/T"
AVIEW
RTN
LBL 46               @@@@ Action for menu key muon
-4.49044830e-26
"Muon Mag Mom[LF]"
├"J/T"
AVIEW
RTN
LBL 47               @@@@ Action for menu key bohr
5.29177210903e-11
"Bohr Radius[LF]"
├"m"
AVIEW
RTN
LBL 48               @@@@ Action for menu key ele
2.8179403262e-15
"Electron Radius"
├"[LF]"
├"m"
AVIEW
RTN
LBL 49               @@@@ Action for menu key std
2.42631023867e-12
"Compton Wavelen"
├"gth[LF]"
├"m"
AVIEW
RTN
LBL 50               @@@@ Action for menu key pro
1.32140985539e-15
"Proton Compton "
├"waveln[LF]"
├"m"
AVIEW
RTN
LBL 51               @@@@ Action for menu key neut
1.31959090581e-15
"Neutron Compton"
├" waveln"
├"m"
AVIEW
RTN
LBL 52               @@@@ Action for menu key muon
1.173444110e-14
"Nuon Compton wa"
├"veln[LF]"
├"m"
