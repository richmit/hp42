...
This org-mode file collects together a handful of simple mathematical stuff I find useful.  Many of these functions work on what I call an "arithmetic
...
* Polynomials
** Quadratic Equation (Coef on Stack)
...
Make a polynomial stored in a matrix into a =MVAR= function suitable for use with SOLVER, INTEG, etc...

#+BEGIN_SRC hp42s :tangle yes
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ (ref:PWRP)
@@@@ DSC: Wrap a polynomial
@@@@ IN:  X: N/A
@@@@ OUT: X: N/A
