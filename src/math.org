...
(MJR-generate-42-menu-code "POLY" tbl "stay" "exit" #'MJR-custom-x-gen)
#+END_SRC
...
(MJR-generate-42-menu-code "VEC3" tbl "stay" "exit" #'MJR-custom-x-gen)
#+END_SRC
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@ DSC: Compute Euclidean norm of vector
@@@@ NAM: MAG 97
@@@@ IN:  X: 1x3 matrix V
@@@@ OUT: Z: First component of V
@@@@      Y: Second component of V
