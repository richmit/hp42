...
|--------+--------+-------+------------------------------------------------------------------|
| FSPT   |        | FSPT  | Interactive application for computing Sums, Products, and Tables |
| LBL 99 |        | FPLT  | Interactive application for plotting a function (DM42 Specific)  |
| ▒▒▒▒   |        | ▒▒▒▒  |                                                                  |
| ▒▒▒▒   |        | ▒▒▒▒  |                                                                  |
| ▒▒▒▒   |        | ▒▒▒▒  |                                                                  |
| ▒▒▒▒   |        | ▒▒▒▒  |                                                                  |
...
(MJR-generate-42-menu-code "FMENU" 0 tbl 0 nil 'stay 'up #'MJR-custom-gen-lab #'MJR-custom-gen-sub)
#+END_SRC
...
EXITALL
RTN
LBL 06    @@@@ Action for menu key SOLVE
SOLVE
RTN
LBL 07    @@@@ Action for menu key SUM
SUM
RTN
