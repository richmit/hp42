...
After the plot is drawn and being shown, we can do three things:
  - [2] [4] [8] [6]  Adjust zoom box
  - [ENTER]          Zoom to box & Redraw
  - [+/-]            Autoscale Y & Redraw.  If zoom box has narrowed x range, then use that range.
  - [5]              Set zoom box adjustment & trace speed
  - [1] [3]          Trace movement
  - [.]              Push trace point to someplace --- duno where...  Stack?
