...
| COMP:▒▒▒▒  |        | COMP:▒▒▒▒  |                                                                  |
| COMP:PICF  | LBL 96 | COMP:PICF  | Interactive application to select and describe an =MVAR= program |
| COMP:▒▒▒▒  |        | COMP:▒▒▒▒  |                                                                  |
| COMP:▒▒▒▒  |        | COMP:▒▒▒▒  |                                                                  |
| COMP:INDP  | LBL 97 | COMP:INDP  | Store/Recall current value of "X"                                |
| COMP:▒▒▒▒  |        | COMP:▒▒▒▒  |                                                                  |
| COMP:EVAL  | FEVL   | COMP:EVAL  | Evaluate EqV on X                                                |
| WRAP:PICF  | LBL 96 | WRAP:PICF  | Interactive application to select and describe an =MVAR= program |
| WRAP:▒▒▒▒  |        | WRAP:▒▒▒▒  |                                                                  |
